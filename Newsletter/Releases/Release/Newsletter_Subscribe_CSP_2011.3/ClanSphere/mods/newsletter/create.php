...
// $Id: create.php 4567 2010-09-21 18:12:42Z hajo $
...
if(!empty($error) OR !isset($_POST['submit'])) {
 ...
 echo cs_subtemplate(__FILE__,$data,'newsletter','create');
   ...
   */
  $where = 'newsletter_user_active = 1';
  $mail_addys = cs_sql_select(__FILE__,'newsletter_user','newsletter_user_email email',$where,0,0,0);

  $mail_targets = array_merge($mail_targets, $mail_addys);
