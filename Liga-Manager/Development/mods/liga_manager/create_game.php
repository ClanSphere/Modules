...
if(isset($_POST['submit'])) {
  ...
  $data['create']['games_day'] = $_POST['day_id'];
  ...
  if(empty($data['create']['games_day'])) {
...
if(!isset($_POST['submit']) OR !empty($error)) {
    ...
    $data['dropdown']['liga'] = cs_liga_dropdown('liga_id','liga_name',$ligen_data,$data['create']['liga_id'],'liga_manager_ligen_id');
