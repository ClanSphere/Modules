...
<table class="forum" style="width:{page:width}">
  ...
  <tr>
	...
	<td class="leftc"><div id="team_1">{dropdown:team1}</div></td>
  </tr>
  <tr>
    <td class="leftb" style="width:150px;">{icon:yast_group_add} {lang:team2_name}</td>
	<td class="leftc"><div id="team_2">{dropdown:team2}</div></td>
  </tr>    
  <tr>
  ...
  <tr>
    <td class="leftb" style="width:150px;">{icon:1day} {lang:date}</td>
