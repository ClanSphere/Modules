...
$tpl_data['head']['pages_navigation']  = cs_pages('codepaste','manage',$cp_count,$start,0,$sort);
$tpl_data['sort']['date']   = cs_sort('codepaste','manage',$start,0,1,$sort);
$tpl_data['sort']['name']   = cs_sort('codepaste','manage',$start,0,3,$sort);
$tpl_data['sort']['mod']    = cs_sort('codepaste','manage',$start,0,5,$sort);
$tpl_data['sort']['version']= cs_sort('codepaste','manage',$start,0,7,$sort);
...
echo cs_subtemplate(__FILE__, $tpl_data, 'codepaste', 'manage');
